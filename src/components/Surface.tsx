...
const styles = StyleSheet.create({ surface: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, padding: 18, ...shadow }, pill: { borderRadius: radius.pill, paddingVertical: 11, paddingHorizontal: 15, borderWidth: 1, borderColor: colors.border, backgroundColor: '#FFFFFF', marginRight: 8, marginBottom: 9 }, pillSelected: { backgroundColor: colors.lilac, borderColor: '#CFC2DC' }, pillText: { color: colors.muted, fontSize: 14, fontWeight: '500' }, pillTextSelected: { color: colors.ink }, label: { color: colors.quiet, letterSpacing: 1.5, textTransform: 'uppercase', fontSize: 10, fontWeight: '700' } });
