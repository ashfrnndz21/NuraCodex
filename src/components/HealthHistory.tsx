...
const C = { canvas: '#F7F5F7', white: '#FFFFFF', ink: '#24232B', muted: '#706A78', faint: '#8D8595', border: '#E3DEE7', cobalt: '#1264F5', cobaltDeep: '#0D54D5', blueLine: '#91B2EE', bluePale: '#EAF1FD', plum: '#483250', lilac: '#F1EAF4', lilacInk: '#735A83', mint: '#DFF2EA', peach: '#F2DDD6', track: '#E9E3EC' };
...
const NODE_COLORS: Record<'record' | 'care' | 'treatment' | 'vitals' | 'life' | 'topic', NodePalette> = {
  record: { node: '#1264E8', pale: '#EAF1FD', line: '#A3C2FF', accent: '#185BC8' },
  care: { node: '#7952A0', pale: '#F0E6F5', line: '#C5ACD8', accent: '#684487' },
  treatment: { node: '#C77A22', pale: '#FFF1D9', line: '#E5BD6C', accent: '#925911' },
  vitals: { node: '#16858C', pale: '#E1F2F0', line: '#8DC9C2', accent: '#176E74' },
  life: { node: '#43855F', pale: '#E6F1E7', line: '#9FCCA9', accent: '#326D4B' },
  topic: { node: '#93618F', pale: '#F0E5F0', line: '#C8AAC8', accent: '#754F76' },
};
