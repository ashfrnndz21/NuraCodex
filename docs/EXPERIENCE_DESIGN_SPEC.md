...
- **Reading surfaces:** history, registries, care, and the feed use a lilac-paper canvas (`#F0EBF3`), warm cream cards (`#FFFBF7`), and a deeper lilac secondary surface (`#EEE7F1`). This keeps long records easy to read while making the background visibly distinct from white cards.
