...
const icons: Record<string, string> = { home: '⌂', health: '◉', connect: '⌁', services: '▤', profile: '○' };
const labels: Record<string, string> = { home: 'Home', health: 'History', connect: 'People', services: 'Explore', profile: 'Profile' };
export default function TabLayout() {
  ...
  })}>{Object.keys(labels).map((name) => <Tabs.Screen key={name} name={name} options={{ title: labels[name] }} />)}</Tabs>;
}
