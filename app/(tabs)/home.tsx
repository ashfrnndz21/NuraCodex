...
const domains = [
  { label: 'Today', detail: 'Biometrics', tint: colors.bluePale, ink: colors.cobalt, match: /vital|biometric|blood pressure/i },
    ...
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.actions}>
        <TapScale reducedMotion={reducedMotion} onPress={() => router.push('/intake')} label="Add a medical record" style={styles.actionCard}>
          <View style={[styles.actionGlyphWrap, { backgroundColor: colors.bluePale }]}><Text style={[styles.actionGlyph, { color: colors.cobalt }]}>＋</Text></View><Text style={styles.actionTitle}>Add a record</Text><Text style={styles.actionSub}>PDF, photo or video</Text><Arrow />
        </TapScale>
...
const styles = StyleSheet.create({
  ...
  emptyRecord: { padding: 16, borderRadius: 17, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, marginBottom: 16 }, emptyRecordTitle: { color: colors.ink, fontSize: 13, fontWeight: '600' }, emptyRecordBody: { color: colors.muted, fontSize: 11, lineHeight: 16, marginTop: 5 }, emptyRecordLink: { color: colors.cobalt, fontSize: 11, fontWeight: '700', marginTop: 9 },
  questionCard: { backgroundColor: colors.surface, padding: 14, borderRadius: 17, borderWidth: 1, borderColor: colors.border, marginBottom: 19 }, questionText: { color: colors.ink, fontSize: 12, lineHeight: 17, marginTop: 6 }, questionLink: { color: colors.cobalt, fontSize: 10, fontWeight: '700', marginTop: 7 },
