...
const styles = StyleSheet.create({
  ...
  heroContent: { flex: 1, paddingRight: 74, zIndex: 1 }, heroKicker: { flexDirection: 'row', alignItems: 'center', gap: 7 }, heroDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#1767D8' }, heroKickerText: { color: '#615777', fontSize: 9, fontWeight: '800', letterSpacing: 1.15 },
  heroTitle: { color: colors.ink, fontSize: 25, lineHeight: 29, fontWeight: '400', letterSpacing: -.8, marginTop: 11 }, heroBody: { color: colors.muted, fontSize: 12, lineHeight: 17, marginTop: 7, maxWidth: 245 },
  heroAction: { minHeight: 34, flexDirection: 'row', alignItems: 'center', gap: 7, alignSelf: 'flex-start', paddingVertical: 5, paddingHorizontal: 9, marginTop: 10, borderRadius: 14, backgroundColor: 'rgba(255,255,255,.72)' }, heroActionText: { color: '#275CA8', fontSize: 11, fontWeight: '700' }, arrow: { color: '#1767D8', fontSize: 16, lineHeight: 19 }, heroOrb: { position: 'absolute', right: 8, top: 39, width: 92, height: 92, alignItems: 'center', justifyContent: 'center' }, orbHalo: { position: 'absolute', height: 88, width: 88, borderRadius: 44, borderWidth: 1, borderColor: 'rgba(118,98,154,.20)', backgroundColor: 'rgba(255,255,255,.18)' },
  ...
  domainGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', gap: 8, marginBottom: 23 }, domainCardWrap: { width: '48%' }, domainCard: { width: '100%', minWidth: 0, minHeight: 92, paddingHorizontal: 12, paddingVertical: 11, borderRadius: 16, borderWidth: 1, borderColor: colors.border, backgroundColor: '#FFFFFF', flexDirection: 'column', alignItems: 'stretch', justifyContent: 'space-between', gap: 8, ...shadow }, domainCardActive: { borderColor: '#D7D2DE', backgroundColor: '#FFFFFF' }, domainCardHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, domainMark: { width: 28, height: 28, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, domainDotSmall: { width: 10, height: 10, borderRadius: 5 }, domainText: { minWidth: 0 }, domainTitle: { color: colors.ink, fontSize: 14, lineHeight: 18, fontWeight: '700' }, domainDetail: { color: colors.muted, fontSize: 11, lineHeight: 15, marginTop: 3 }, domainCount: { color: '#777480', fontSize: 12, fontWeight: '700' },
  ...
  recentList: { marginBottom: 20 }, recentCard: { minHeight: 73, borderRadius: 16, borderWidth: 1, borderColor: colors.border, backgroundColor: '#FFFFFF', paddingHorizontal: 10, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 9, ...shadow }, recentCardNext: { marginTop: 7 }, recentDate: { width: 30, alignItems: 'center' }, recentDateDay: { color: colors.ink, fontSize: 14, fontWeight: '600' }, recentDateMonth: { color: colors.quiet, fontSize: 8, fontWeight: '700', letterSpacing: .7, marginTop: 1 }, recentNode: { width: 35, height: 35, borderRadius: 18, backgroundColor: '#1264F5', borderWidth: 1, borderColor: '#A7C5FF', alignItems: 'center', justifyContent: 'center' }, recentNodeGlyph: { color: '#FFFFFF', fontSize: 16 }, recentText: { flex: 1 }, recentMeta: { flexDirection: 'row', alignItems: 'center', gap: 4 }, recentType: { color: '#1767D8', fontSize: 8, fontWeight: '800', letterSpacing: .7 }, recentMetaDot: { color: colors.quiet, fontSize: 9 }, recentSource: { color: colors.quiet, fontSize: 9, flex: 1 }, recentTitle: { color: colors.ink, fontSize: 12, fontWeight: '600', marginTop: 3 }, recentDetail: { color: colors.muted, fontSize: 10, marginTop: 2 },
  emptyRecord: { padding: 16, borderRadius: 17, borderWidth: 1, borderColor: colors.border, backgroundColor: '#FFFFFF', marginBottom: 16 }, emptyRecordTitle: { color: colors.ink, fontSize: 13, fontWeight: '600' }, emptyRecordBody: { color: colors.muted, fontSize: 11, lineHeight: 16, marginTop: 5 }, emptyRecordLink: { color: '#1767D8', fontSize: 11, fontWeight: '700', marginTop: 9 },
  questionCard: { backgroundColor: '#FFFFFF', padding: 14, borderRadius: 17, borderWidth: 1, borderColor: colors.border, marginBottom: 19 }, questionText: { color: colors.ink, fontSize: 12, lineHeight: 17, marginTop: 6 }, questionLink: { color: '#1767D8', fontSize: 10, fontWeight: '700', marginTop: 7 },
