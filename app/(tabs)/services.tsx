...
const styles = StyleSheet.create({
  ...
  consentCard: { padding: 15, marginBottom: 13 }, consentTop: { flexDirection: 'row', gap: 10, alignItems: 'flex-start' }, consentIcon: { width: 35, height: 35, borderRadius: 13, backgroundColor: '#EAF1FD', alignItems: 'center', justifyContent: 'center' }, consentIconText: { fontSize: 23, lineHeight: 25, color: '#1767D8' }, consentTitle: { color: colors.ink, fontSize: 14, fontWeight: '600', lineHeight: 18 }, consentBody: { color: colors.muted, fontSize: 12, lineHeight: 18, marginTop: 4 }, topicLabelRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 14 }, selectedCount: { color: colors.violet, fontSize: 11, fontWeight: '600' }, topicList: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 8 }, noTopics: { backgroundColor: '#F5F3F7', borderRadius: 13, padding: 11, marginTop: 9 }, noTopicsText: { color: colors.muted, fontSize: 12, lineHeight: 15 }, inlineLink: { color: '#1767D8', fontSize: 12, fontWeight: '700', marginTop: 7 }, limitNote: { color: '#9A6B24', fontSize: 11, marginTop: 2 }, consentToggle: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, paddingVertical: 11, borderTopWidth: 1, borderTopColor: colors.border, marginTop: 3 }, checkBox: { width: 19, height: 19, borderRadius: 6, borderWidth: 1.5, borderColor: '#B7AFBF', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, checkBoxOn: { backgroundColor: '#1767D8', borderColor: '#1767D8' }, checkMark: { color: '#FFFFFF', fontSize: 12, fontWeight: '800' }, consentToggleText: { flex: 1, color: colors.text, fontSize: 12, lineHeight: 15, paddingTop: 1 }, sourceTrust: { flexDirection: 'row', alignItems: 'flex-start', gap: 7, backgroundColor: '#F4F2F6', paddingHorizontal: 9, paddingVertical: 8, borderRadius: 11 }, statusDot: { width: 7, height: 7, borderRadius: 4, marginTop: 3, backgroundColor: '#D2CCD7' }, statusDotOn: { backgroundColor: '#34845B' }, statusDotOff: { backgroundColor: '#BD8842' }, sourceTrustText: { flex: 1, color: colors.muted, fontSize: 11, lineHeight: 13 }, refresh: { color: colors.violet, fontSize: 17, lineHeight: 20 }, sourceRefreshButton: { minWidth: 44, minHeight: 44, alignItems: 'center', justifyContent: 'center' }, searchButton: { minHeight: 46, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, backgroundColor: '#1767D8', borderRadius: 15, marginTop: 11, ...shadow }, searchDisabled: { backgroundColor: '#9AB7E9', opacity: 0.76 }, searchButtonText: { color: '#FFFFFF', fontSize: 11, fontWeight: '700' }, searchArrow: { color: '#FFFFFF', fontSize: 19, marginTop: -1 }, safetyNote: { color: colors.quiet, fontSize: 10, lineHeight: 14, textAlign: 'center', marginTop: 8 },
