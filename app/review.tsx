...
export default function Review() {
  ...
  return <View style={styles.page}><ScrollView ref={scrollRef} contentContainerStyle={styles.content}>
    ...
    <Text style={styles.intro}>{purpose === 'insurance' ? 'After you confirm, Nura will highlight stated policy terms and show their source. Use these details to prepare questions; they are not a coverage decision.' : 'After you confirm, Nura will read this file and show each suggested detail with a quote or video timecode. Review, edit or dismiss every suggestion before anything is added to your record.'}</Text>
